var translations = {
    fr: {
        ...
        "home.tile.rovers.title": "Rovers martiens",
        "home.tile.rovers.desc": "Explorez la surface de Mars à travers les yeux de Curiosity et Perseverance.",
        ...
        "position.h1": "Où se trouve l'ISS en ce moment ?",
        "position.lead": "Sa trajectoire actuelle au-dessus de la Terre, mise à jour en continu.",
        ...
        "live.h1": "Vue en direct depuis l'ISS",

        "rovers.title": "Rovers martiens — Suivi ISS",
        "rovers.kicker": "Exploration martienne",
        "rovers.h1": "Photos des rovers sur Mars",
        "rovers.lead": "Parcourez les images brutes envoyées par Curiosity et Perseverance, jour après jour.",
        "rovers.roverLabel": "Rover",
        "rovers.cameraFilterLabel": "Caméra",
        "rovers.allCameras": "Toutes les caméras",
        "rovers.modeLabel": "Rechercher par",
        "rovers.solLabel": "Sol",
        "rovers.dateLabel": "Date Terre",
        "rovers.search": "Rechercher",
        "rovers.clearCache": "Vider le cache",
        "rovers.loading": "Chargement...",
        "rovers.searchingGeneric": "Recherche en cours...",
        "rovers.cached": "Photos chargées depuis le cache ({count} images).",
        "rovers.found": "{count} photos affichées pour le Sol {sol} !",
        "rovers.none": "Aucune photo enregistrée pour le Sol {sol}. Utilisez + ou - pour naviguer.",
        "rovers.invalidSol": "Veuillez saisir un numéro de Sol valide (≥ 0).",
        "rovers.invalidDate": "Veuillez choisir une date valide.",
        "rovers.error": "Erreur : {message}",
        "rovers.cacheCleared": "Cache vidé pour ce Sol.",
        "rovers.earthDateLabel": "Date Terre",
        "rovers.solShort": "Sol",
        "rovers.unknownCamera": "Caméra inconnue",
        "rovers.sampleTypeLabel": "Type",
        "rovers.close": "Fermer",
        "rovers.prev": "Photo précédente",
        "rovers.next": "Photo suivante",
        "rovers.perseverance": "Perseverance",
        "rovers.curiosity": "Curiosity"
    },
    en: {
        "nav.home": "Home",
        "nav.crew": "Crew",
        ...
        "home.tile.rovers.title": "Mars Rovers",
        "home.tile.rovers.desc": "Explore the Martian surface through the eyes of Curiosity and Perseverance.",
        ...
        "equipage.kicker": "Crew",
        "equipage.h1": "Seven people currently live aboard the ISS.",
        ...
        "position.h1": "Where is the ISS right now?",
        "position.lead": "Its current trajectory above the Earth, updated continuously.",
        "position.live": "Live",
        "position.altitude": "Altitude",
        ...
        "live.h1": "Live view from the ISS",

        "rovers.title": "Mars Rovers — ISS Tracker",
        "rovers.kicker": "Mars exploration",
        "rovers.h1": "Photos from the Mars rovers",
        "rovers.lead": "Browse the raw images sent back by Curiosity and Perseverance, day by day.",
        "rovers.roverLabel": "Rover",
        "rovers.cameraFilterLabel": "Camera",
        "rovers.allCameras": "All cameras",
        "rovers.modeLabel": "Search by",
        "rovers.solLabel": "Sol",
        "rovers.dateLabel": "Earth date",
        "rovers.search": "Search",
        "rovers.clearCache": "Clear cache",
        "rovers.loading": "Loading...",
        "rovers.searchingGeneric": "Searching...",
        "rovers.cached": "Photos loaded from cache ({count} images).",
        "rovers.found": "{count} photos shown for Sol {sol}!",
        "rovers.none": "No photos recorded for Sol {sol}. Use + or - to navigate.",
        "rovers.invalidSol": "Please enter a valid Sol number (≥ 0).",
        "rovers.invalidDate": "Please choose a valid date.",
        "rovers.error": "Error: {message}",
        "rovers.cacheCleared": "Cache cleared for this Sol.",
        "rovers.earthDateLabel": "Earth date",
        "rovers.solShort": "Sol",
        "rovers.unknownCamera": "Unknown camera",
        "rovers.sampleTypeLabel": "Type",
        "rovers.close": "Close",
        "rovers.prev": "Previous photo",
        "rovers.next": "Next photo",
        "rovers.perseverance": "Perseverance",
        "rovers.curiosity": "Curiosity"
    }
};
